...
**说明**：
- “投稿状态”和“投稿平台”列基于你提供的信息，如有变化可随时更新。
- 所有文件链接均为 GitHub 原始链接，确保可访问。
- 稳定存档部分的 DOI 已按你提供的概念 DOI 录入，每篇对应一组中英文论文（或同一主题的多个版本）。
